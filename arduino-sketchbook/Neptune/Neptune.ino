...
#define NEOPIXEL_CNT 144

#define NEOPIXEL_FRAMERATE (1000 / 15)
#define NEOPIXEL_HUE_GAP (0x10000 / NEOPIXEL_CNT)
#define NEOPIXEL_HUE_ADD (0x10000 / NEOPIXEL_CNT)
#define NEOPIXEL_BRIGHTNESS_FULL  128
#define NEOPIXEL_BRIGHTNESS_HALF  32
#define NEOPIXEL_BRIGHTNESS_LOW   16

#define PWRSTATE_SLEEP_PULSE 3000
#define PWRSTATE_ON_TIMEOUT 3000
#define PWRSTATE_OFF_TIMEOUT 3000
...
void loop() {
  ...
  if (pwr_led != false && prev_pwr_led == false)
  {
